...
latex_documents = [
  ('index', 'Flyingpigeon.tex', u'Flyingpigeon Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    ('index', 'flyingpigeon', u'Flyingpigeon Documentation',
     [u'Birdhouse'], 1)
]
...
texinfo_documents = [
  ('index', 'Flyingpigeon', u'Flyingpigeon Documentation',
   u'Birdhouse', 'Flyingpigeon', 'One line description of project.',
   'Miscellaneous'),
]

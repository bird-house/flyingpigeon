...
extensions = [
    ...
    'sphinx.ext.autodoc',
    'sphinx.ext.napoleon',
#    'sphinx_autodoc_pywps'  # Uncomment to enable smart autodoc for pywps.Process. Code at https://github.com/huard/sphinx-autodoc-pywps
]
...
latex_documents = [
  (master_doc, 'project.tex', u'Flyingpigeon Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    (master_doc, 'project', u'Flyingpigeon Documentation',
     [author], 1)
]

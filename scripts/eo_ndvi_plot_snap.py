...
source = '/home/nils/data/snap/S2B_MSIL1C_20171230T092359_N0206_R093_T33PVK_20171230T130034vFlsZR.tif'

# source = '/home/nils/data/ndvi_SENTINE2ogmvEh.tif'
sourceProduct = ProductIO.readProduct(source)
list(sourceProduct.getBandNames())
...
JAI.create("filestore", im, 'snappy_image.png', image_format)

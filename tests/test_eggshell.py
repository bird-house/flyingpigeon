...
def test_get_variable():
    variable = nc_utils.get_variable(local_path(TESTDATA['cmip5_tasmax_2007_nc']))
    assert 'tasmax' == variable
    variable = nc_utils.get_variable(local_path(TESTDATA['cordex_tasmax_2007_nc']))
    assert 'tasmax' == variable

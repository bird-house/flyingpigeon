...
class IndicesCalculatorTestCase(WpsTestCase):
    ...
    def test_su_tasmax(self):
        ...
        inputs.append(
            ('resource', TESTDATA['tasmax_WAS-44_MPI-M-MPI-ESM-LR_historical_r1i1p1_MPI-CSC-REMO2009_v1_day_20010101-20051231.nc']))

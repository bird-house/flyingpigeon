...
def test_indices():
    result = wpsclient.execute(
        ...
        inputs = [('netcdf_file', TESTDATA['tasmax_EUR-44_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day_20510101-20551231.nc']),
                  ...
                  ('ID','True'),
                  # ('CSU','True'),
                  #('TG','True'),('TX','True'),('TXx','True'),
                  #('TXn','True'), ('TN','True'), ('TNx','True'),
                  #('TNn','True'),  ('FD','True'),('CFD','True'),
                  #('TR','True'), , ('HD17','True'), ('GD4','True'), ('RR','True'), ('RR1','True'),('CWD','True'), ('SDII','True'), ('R10mm','True'), ('R20mm','True'),('RX1day','True'), ('RX5day','True'), ('SD','True'), ('SD1','True'),('SD5cm','True'), ('SD50cm','True'), ('CDD','True') 
                  ],

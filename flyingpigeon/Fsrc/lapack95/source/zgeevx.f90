...
PURE SUBROUTINE ZGEEVX_F95(A,W,VL,VR,BALANC,ILO,IHI,SCALE,ABNRM,RCONDE, &
     &                                                      RCONDV,INFO)
    ! Fortran77 call:
    ! ZGEEVX(BALANC,JOBVL,JOBVR,SENSE,N,A,LDA,W,VL,LDVL,VR,LDVR,ILO,IHI,
    !   SCALE,ABNRM,RCONDE,RCONDV,WORK,LWORK,RWORK,INFO)
    ! BALANC='N','B','P','S'; default: 'N'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_GEEVX, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY ZGEEVX_MKL95(A,W,VL,VR,BALANC,ILO,IHI,SCALE,ABNRM,RCONDE,     &
     &                                                      RCONDV,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>

...
PURE SUBROUTINE CPPTRS_F95(AP,B,UPLO,INFO)
    ...
    ! UPLO='U','L'; default: 'U'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_PPTRS, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY CPPTRS_MKL95(AP,B,UPLO,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=5), PARAMETER :: SRNAME = 'PPTRS'
    ! <<< Local scalars >>>
    ...
    CALL F77_PPTRS(O_UPLO,N,NRHS,AP,B,LDB,O_INFO)
    ! <<< Error handler >>>

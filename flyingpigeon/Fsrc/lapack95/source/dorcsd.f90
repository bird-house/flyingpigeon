...
PURE SUBROUTINE DORCSD_F95(X11,X12,X21,X22,THETA,U1,U2,V1T,V2T,JOBU1,   &
     &                             JOBU2,JOBV1T,JOBV2T,TRANS,SIGNS,INFO)
    ! Fortran77 call:
    ! DORCSD(JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,SIGNS,M,P,Q,X11,LDX11,X12,
    ...
    ! <<< ENTRY point >>>
    ENTRY DORCSD_MKL95(X11,X12,X21,X22,THETA,U1,U2,V1T,V2T,JOBU1,JOBU2, &
...
!    Not inited: 1 scalars (special=1)
    ...
    ENDIF
    ! Error while build wrapper: DORCSD

...
PURE SUBROUTINE SPPSV_F95(AP,B,UPLO,INFO)
    ...
    ! UPLO='U','L'; default: 'U'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_PPSV, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY SPPSV_MKL95(AP,B,UPLO,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=4), PARAMETER :: SRNAME = 'PPSV'
    ! <<< Local scalars >>>
    ...
    CALL F77_PPSV(O_UPLO,N,NRHS,AP,B,LDB,O_INFO)
    ! <<< Error handler >>>

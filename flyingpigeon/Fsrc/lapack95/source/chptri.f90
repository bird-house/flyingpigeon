...
PURE SUBROUTINE CHPTRI_F95(AP,IPIV,UPLO,INFO)
    ...
    ! UPLO='U','L'; default: 'U'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_HPTRI, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY CHPTRI_MKL95(AP,IPIV,UPLO,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=5), PARAMETER :: SRNAME = 'HPTRI'
    ! <<< Local scalars >>>
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL F77_HPTRI(O_UPLO,N,AP,IPIV,WORK,O_INFO)
    ELSE; O_INFO = -1000
    ENDIF

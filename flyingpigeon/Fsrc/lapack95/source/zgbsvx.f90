...
PURE SUBROUTINE ZGBSVX_F95(AB,B,X,KL,AFB,IPIV,FACT,TRANS,EQUED,R,C,FERR,&
     &                                           BERR,RCOND,RPVGRW,INFO)
    ! Fortran77 call:
    ! ZGBSVX(FACT,TRANS,N,KL,KU,NRHS,AB,LDAB,AFB,LDAFB,IPIV,EQUED,R,C,B,
    ...
    ! <<< ENTRY point >>>
    ENTRY ZGBSVX_MKL95(AB,B,X,KL,AFB,IPIV,FACT,TRANS,EQUED,R,C,FERR,    &
     &                                           BERR,RCOND,RPVGRW,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>

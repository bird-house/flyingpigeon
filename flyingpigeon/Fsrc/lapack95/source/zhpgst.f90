...
PURE SUBROUTINE ZHPGST_F95(AP,BP,ITYPE,UPLO,INFO)
    ...
    ! UPLO='U','L'; default: 'U'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_HPGST, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY ZHPGST_MKL95(AP,BP,ITYPE,UPLO,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=5), PARAMETER :: SRNAME = 'HPGST'
    ! <<< Local scalars >>>
    INTEGER :: O_ITYPE
    ...
    CALL F77_HPGST(O_ITYPE,O_UPLO,N,AP,BP,O_INFO)
    ! <<< Error handler >>>

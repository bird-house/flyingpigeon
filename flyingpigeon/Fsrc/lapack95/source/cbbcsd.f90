...
PURE SUBROUTINE CBBCSD_F95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E, &
     &         B21D,B21E,B22D,B22E,JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,INFO)
    ! Fortran77 call:
    ! CBBCSD(JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,M,P,Q,THETA,PHI,U1,LDU1,U2,
    ...
    ! <<< ENTRY point >>>
    ENTRY CBBCSD_MKL95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E,B21D,&
    ...
    ENDIF
    ! Error while build wrapper: CBBCSD

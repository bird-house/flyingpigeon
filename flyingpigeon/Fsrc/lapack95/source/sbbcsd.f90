...
PURE SUBROUTINE SBBCSD_F95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E, &
     &         B21D,B21E,B22D,B22E,JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,INFO)
    ! Fortran77 call:
    ! SBBCSD(JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,M,P,Q,THETA,PHI,U1,LDU1,U2,
    !   LDU2,V1T,LDV1T,V2T,LDV2T,B11D,B11E,B12D,B12E,B21D,B21E,B22D,
    !   B22E,WORK,LWORK,INFO)
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_BBCSD, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY SBBCSD_MKL95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E,B21D,&
    ...
    ENDIF
    ! Error while build wrapper: SBBCSD

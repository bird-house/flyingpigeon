...
PURE SUBROUTINE ZUNBDB_F95(X11,X12,X21,X22,THETA,PHI,TAUP1,TAUP2,TAUQ1, &
     &                                           TAUQ2,TRANS,SIGNS,INFO)
    ! Fortran77 call:
    ! ZUNBDB(TRANS,SIGNS,M,P,Q,X11,LDX11,X12,LDX12,X21,LDX21,X22,LDX22,
    !   THETA,PHI,TAUP1,TAUP2,TAUQ1,TAUQ2,WORK,LWORK,INFO)
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_UNBDB, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY ZUNBDB_MKL95(X11,X12,X21,X22,THETA,PHI,TAUP1,TAUP2,TAUQ1,     &
     &                                           TAUQ2,TRANS,SIGNS,INFO)
    ...
    ! Error while build wrapper: ZUNBDB

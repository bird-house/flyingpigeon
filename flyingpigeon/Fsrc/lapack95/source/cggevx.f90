...
PURE SUBROUTINE CGGEVX_F95(A,B,ALPHA,BETA,VL,VR,BALANC,ILO,IHI,LSCALE,  &
     &                            RSCALE,ABNRM,BBNRM,RCONDE,RCONDV,INFO)
    ! Fortran77 call:
    ! CGGEVX(BALANC,JOBVL,JOBVR,SENSE,N,A,LDA,B,LDB,ALPHA,BETA,VL,LDVL,
    ...
    ! <<< ENTRY point >>>
    ENTRY CGGEVX_MKL95(A,B,ALPHA,BETA,VL,VR,BALANC,ILO,IHI,LSCALE,      &
     &                            RSCALE,ABNRM,BBNRM,RCONDE,RCONDV,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>

...
PURE SUBROUTINE DORBDB_F95(X11,X12,X21,X22,THETA,PHI,TAUP1,TAUP2,TAUQ1, &
     &                                           TAUQ2,TRANS,SIGNS,INFO)
    ! Fortran77 call:
    ! DORBDB(TRANS,SIGNS,M,P,Q,X11,LDX11,X12,LDX12,X21,LDX21,X22,LDX22,
    !   THETA,PHI,TAUP1,TAUP2,TAUQ1,TAUQ2,WORK,LWORK,INFO)
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_ORBDB, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY DORBDB_MKL95(X11,X12,X21,X22,THETA,PHI,TAUP1,TAUP2,TAUQ1,     &
     &                                           TAUQ2,TRANS,SIGNS,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
...
!    Not inited: 1 scalars (special=1)
    ...
    ! Error while build wrapper: DORBDB

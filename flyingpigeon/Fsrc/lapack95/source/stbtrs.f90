...
PURE SUBROUTINE STBTRS_F95(AB,B,UPLO,TRANS,DIAG,INFO)
    ...
    ! DIAG='N','U'; default: 'N'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_TBTRS, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY STBTRS_MKL95(AB,B,UPLO,TRANS,DIAG,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    CALL F77_TBTRS(O_UPLO,O_TRANS,O_DIAG,N,KD,NRHS,AB,LDAB,B,LDB,O_INFO)
    ! <<< Error handler >>>

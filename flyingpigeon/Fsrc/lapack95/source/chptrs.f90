...
PURE SUBROUTINE CHPTRS_F95(AP,B,IPIV,UPLO,INFO)
    ...
    ! UPLO='U','L'; default: 'U'
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_HPTRS, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY CHPTRS_MKL95(AP,B,IPIV,UPLO,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=5), PARAMETER :: SRNAME = 'HPTRS'
    ! <<< Local scalars >>>
    ...
    CALL F77_HPTRS(O_UPLO,N,NRHS,AP,IPIV,B,LDB,O_INFO)
    ! <<< Error handler >>>

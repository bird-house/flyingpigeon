...
PURE SUBROUTINE DBBCSD_F95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E, &
     &         B21D,B21E,B22D,B22E,JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,INFO)
    ! Fortran77 call:
    ! DBBCSD(JOBU1,JOBU2,JOBV1T,JOBV2T,TRANS,M,P,Q,THETA,PHI,U1,LDU1,U2,
    !   LDU2,V1T,LDV1T,V2T,LDV2T,B11D,B11E,B12D,B12E,B21D,B21E,B22D,
    !   B22E,WORK,LWORK,INFO)
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_BBCSD, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY DBBCSD_MKL95(THETA,PHI,U1,U2,V1T,V2T,B11D,B11E,B12D,B12E,B21D,&
    ...
    CALL F77_BBCSD(O_JOBU1,O_JOBU2,O_JOBV1T,O_JOBV2T,O_TRANS,M,P,Q,     &
     ...
     &    O_B12D,O_B12E,O_B21D,O_B21E,O_B22D,O_B22E,S_WORK,LWORK,O_INFO)
    ...
    ENDIF
    ! Error while build wrapper: DBBCSD
    ! <<< Call lapack77 routine >>>
    IF(L_STAT_ALLOC==0) THEN
        CALL F77_BBCSD(O_JOBU1,O_JOBU2,O_JOBV1T,O_JOBV2T,O_TRANS,M,P,Q, &
     &     THETA,PHI,U1,LDU1,U2,LDU2,V1T,LDV1T,V2T,LDV2T,O_B11D,O_B11E, &
     &      O_B12D,O_B12E,O_B21D,O_B21E,O_B22D,O_B22E,WORK,LWORK,O_INFO)
    ELSE; O_INFO = -1000
    ENDIF

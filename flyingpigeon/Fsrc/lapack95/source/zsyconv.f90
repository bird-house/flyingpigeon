...
PURE SUBROUTINE ZSYCONV_F95(A,IPIV,UPLO,WAY,INFO)
    ! Fortran77 call:
    ! ZSYCONV(UPLO,WAY,N,A,LDA,IPIV,WORK,INFO)
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_SYCONV, F77_XERBLA
    ! <<< ENTRY point >>>
    ENTRY ZSYCONV_MKL95(A,IPIV,UPLO,WAY,INFO)
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL F77_SYCONV(O_UPLO,O_WAY,N,A,LDA,IPIV,WORK,O_INFO)
    ELSE; O_INFO = -1000
    ENDIF

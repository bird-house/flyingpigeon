...
class SDMcsvindicesProcess(WPSProcess):
    ...
    def __init__(self):
        WPSProcess.__init__(
            ...
            abstract="Species distribution model for tree species based on GBIF presence/absence data and precalculated Indices",
        ...
        self.output_gbif = self.addComplexOutput(
            ...
            abstract="PNG graphic file showing the presence of tree species according to the CSV file",

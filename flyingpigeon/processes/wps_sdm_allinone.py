...
class SDMallinoneProcess(WPSProcess):
    ...
    def __init__(self):
        WPSProcess.__init__(
            ...
            abstract="Species distribution model for tree species based on scientific species name and raw model data. GBIF data fetch and indices calculation will be done within the process",

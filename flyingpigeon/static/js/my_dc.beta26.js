...
dc.dateFormat = d3.time.format('%d/%m/%Y'); //CN change
...
dc.pieChart = function (parent, chartGroup) {
    ...
    _chart.cx = function (cx) {
        if (!arguments.length) {
            ...
            return _chart.width() / 7; //CN change
        }
        _cx = cx;
        return _chart;
    };
    ...
    _chart.cy = function (cy) {
        if (!arguments.length) {
            ...
            return _chart.height() / 2; //CN change
        }
        _cy = cy;
        return _chart;
    };
...
dc.barChart = function (parent, chartGroup) {
    ...
    // _chart.extendBrush = function () {
    //     var extent = _chart.brush().extent();
    //     console.log("_chart.extendBrush in dc.barChart, extent : ", extent)
    //     console.log("_chart.extendBrush in dc.barChart, _chart.brush().empty(): ", _chart.brush().empty())
    //     if (_chart.round() && (!_centerBar || _alwaysUseRounding)) {
    //         extent[0] = extent.map(_chart.round())[0];
    //         extent[1] = extent.map(_chart.round())[1];
    ...
    //     console.log("_chart.extendBrush in dc.barChart, return extent: ", extent)
    //     return extent;
    // };
...
dc.compositeChart = function (parent, chartGroup) {
    ...
    _chart._brushing = function () {
        ...
        console.log("chart_brushing in dc.compositeChart")      
